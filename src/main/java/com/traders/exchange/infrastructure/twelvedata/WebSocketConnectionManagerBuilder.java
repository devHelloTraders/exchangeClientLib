...
public class WebSocketConnectionManagerBuilder {
    ...
    private TwelveDataWebSocketHandler handler;
    private String url;
    ...
    public WebSocketConnectionManagerBuilder withHandler(TwelveDataWebSocketHandler handler) {
    ...
    public static class CustomWebSocketConnectionManager extends WebSocketConnectionManager {
        ...
        public CustomWebSocketConnectionManager(StandardWebSocketClient client, TwelveDataWebSocketHandler handler, String url) {
        ...
        public TwelveDataWebSocketHandler getHandler() {
            return handler;
        }
    }
}